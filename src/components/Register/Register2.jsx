...
const Register2 = () => {
    ...
    return (
        <div className="min-h-screen ">
            <h1 className="text-3xl md:text-5xl font-bold text-center text-rose-600 py-10 ">Register</h1>
                ...
                <div className="w-full md:w-2/3 max-w-md p-2 space-y-1 rounded-xl ">
                    <form onSubmit={handleRegister} novalidate="" action="" className="space-y-6 ">
                        <div className="space-y-1 text-sm">
                            <label for="name" className="block text-rose-700">Username</label>
                            <input type="text" name="name" id="name" placeholder="User Name" className="w-full px-4 py-3 rounded-md bg-rose-50" />
                        </div>
                        <div className="space-y-1 text-sm">
                        ...
                        <div className="space-y-1 text-sm">
                            ...
                            <input type="text" id="photo" placeholder="Photo URL" name="photo" className="w-full px-4 py-3 rounded-md bg-rose-50" />
                        </div>
                        <div className="space-y-1 text-sm">
                    ...
                    <p className="text-xs text-center sm:px-6 text-rose-700">Already have an account?
