...
const Register = () => {
    ...
    return (
        <div className=" bg-gradient-to-b from-pink-100 to-base-100 min-h-screen ">
                       <h1 className="text-3xl pt-5 font-semibold text-center text-gray-900">Sign Up</h1>
           <div className="flex flex-col md:flex-row items-center justify-center w-3/5 mx-auto  border-black py-10 rounded-lg ">
                ...
                <div className="w-full lg:w-1/2 my-0 md:mt-1 bg-base-100 rounded-r-lg py-3 h-[90vh] mx-auto ">
                    ...
                    <p className="text-xs text-center sm:px-6 text-gray-600 font-semibold">Already have an account?
                        <Link href='/login'
                            className="text-[#FF385C] ml-2 font-semibold text-xs mb-10" >Sign In</Link>
                    </p>
                    {/* {
