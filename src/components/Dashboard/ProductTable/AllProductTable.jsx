    ...
    return (
        <div>
            <div className="flex items-center justify-between w-full">
                <h2 className="text-lg font-semibold">All Property</h2>
                <button className="px-4 py-2 bg-rose-400 text-black rounded-lg hover:bg-rose-600">Refresh</button>
            </div>
                            ...
                            <tr key={property._id}>
                                ...
                                <td>
                                    <Image
                                        width={100}
                                        height={100}
                                        src={`/images/${property.productPhoto}`}
                                        alt="image"
                                    />
                                </td>
