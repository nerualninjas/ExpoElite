...
const PropertyVsSold2 = () => {

    const { AllPropertyLength } = usePropertyAllData();
    const { AllSoldPropertyLength } = useGetSoldProperty();

    const data = [

        { name: 'Total Property', value: AllPropertyLength },
        { name: 'Total Sold Property', value: AllSoldPropertyLength },
...
export default PropertyVsSold2;
