    ...
    return (
        <div>
            <div className="card  bg-base-100 px-5 py-8 justify-around items-center flex flex-col lg:flex-row ">
                ...
                <div className="radial-progress text-rose-500" style={{"--value":"100", "--size": "6rem", "--thickness": "4px"}} role="progressbar"><Image width={400} height={400} src={user?.photoURL}  alt="image" /></div>
