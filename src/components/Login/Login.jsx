...
const Login = () => {
    ...
    return (
        <div className="bg-gradient-to-b p-0 m-0 from-pink-100 to-base-100 min-h-screen  ">
            <h1 className="text-3xl py-5 font-semibold text-center text-gray-900">Sign In</h1>
            <div className="flex flex-col md:flex-row items-center justify-center w-3/5 mx-auto  border-black py-10 rounded-lg ">
                ...
                <div className="w-full lg:w-1/2 my-0 md:mt-1 bg-base-100 rounded-r-lg py-3 h-[80vh] max-w-md p-8 space-y-3 ">
                    {/* <h1 className="text-2xl font-bold text-center">Login</h1> */}
                    <form novalidate="" action="" className="space-y-6 pt-10">
                        <div className="space-y-1 text-sm">
                            <label for="username" className="block text-gray-600 font-semibold">Username</label>
                        ...
                        <div className="space-y-1 text-sm">
                            ...
                            <div className="flex justify-end text-xs text-gray-600 font-semibold">
                    ...
                    <div className="flex items-center pt-4 space-x-1">
                        ...
                        <p className="px-3 text-sm text-gray-600 font-semibold">Login with social accounts</p>
                        <div className="flex-1 h-px sm:w-16 "></div>
                    </div>
                    <div className="flex justify-center space-x-4">
                        <button aria-label="Log in with Google" className="p-3 rounded-sm">
                            {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 text-[#FF385C]">
                                    <path d="M16.318 13.714v5.484h9.078c-0.37 2.354-2.745 6.901-9.078 6.901-5.458 0-9.917-4.521-9.917-10.099s4.458-10.099 9.917-10.099c3.109 0 5.193 1.318 6.38 2.464l4.339-4.182c-2.786-2.599-6.396-4.182-10.719-4.182-8.844 0-16 7.151-16 16s7.156 16 16 16c9.234 0 15.365-6.49 15.365-15.635 0-1.052-0.115-1.854-0.255-2.651z"></path>
                                </svg> */}
                            <FaGoogle className="text-[#FF385C] text-2xl"></FaGoogle>
                        </button>
                        <button aria-label="Log in with Twitter" className="p-3 rounded-sm">
                            ...
                            <FaFacebook className="text-[#FF385C] text-2xl"></FaFacebook>
                        </button>
                        <button aria-label="Log in with GitHub" className="p-3 rounded-sm">
                            ...
                            <FaInstagram className="text-[#FF385C] text-2xl"></FaInstagram>
                        </button>
                    </div>
                    <p className="text-xs text-center sm:px-6 text-gray-600 font-semibold">Do not have an account?
                        <Link href='/login'
                            className="text-[#FF385C] ml-2 font-semibold text-xs mb-10" >Sign Up</Link>
                    </p>
                    {/* {
