...
const ContactBanner2 = () => {
    ...
    return (
        <div className="bg-gradient-to-r from-pink-200 to-pink-50 md:h-96 rounded-lg flex flex-col md:flex-row justify-between">
            <div className="w-full md:w-1/2 flex flex-col items-center md:items-start justify-center pt-10   ">
                <Title2 title="Contact Us" heading=" Send us your thoughts! We are happy to hear from you. We are at your
                    service!" />
                ...
                <ul>
                    <li className="flex items-center gap-6 text-xl md:text-2xl lg:text-3xl ml-10 text-rose-600 md:my-2">
