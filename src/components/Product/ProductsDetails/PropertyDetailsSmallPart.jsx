...
const PropertyDetailsSmallPart = ({ propertyId }) => {
    ...
    const { propertyName, propertyType,propertyCategory, price, image, bathrooms, bedrooms, livingRoom } = propertySingleData || {};
    return (
        <div className='w-full bg-rose-200 -translate-y-56 md:-translate-y-32  rounded py-10 md:py-10 px-4 md:px-20 my-10 '>
            <div className='flex flex-col md:flex-row justify-between items-center gap-4'>
              ...
              <Image  src={image} alt="property image" width={150} height={150} />
                ...
                {/* Compare route will be here */}
                <Link href={'/compare'} className='bg-rose-600 hover:bg-rose-100 text-white hover:text-rose-700 px-4 py-2 rounded text-extrabold'>Wanna Compare?</Link>
            </div>
        </div>
    );
};
